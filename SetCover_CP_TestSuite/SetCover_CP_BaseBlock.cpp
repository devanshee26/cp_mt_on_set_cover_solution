...
TEST(CategoryPartition_BaseBlockCriteria, TestCase3) {
    register_signal_handler();
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/CP_TestsWithoutErrorBlocks/CP_BaseBlock/test_3.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
    
        std::string expectedOutputFileName = "expected_outputs/CP_TestsWithoutErrorBlocks/CP_BaseBlock/output_3.txt";
...
TEST(CategoryPartition_BaseBlockCriteria, TestCase4) {  
    register_signal_handler();  
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/CP_TestsWithoutErrorBlocks/CP_BaseBlock/test_4.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
    
        std::string expectedOutputFileName = "expected_outputs/CP_TestsWithoutErrorBlocks/CP_BaseBlock/output_4.txt";
...
TEST(CategoryPartition_BaseBlockCriteria, TestCase5) {  
    register_signal_handler();  
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/CP_TestsWithoutErrorBlocks/CP_BaseBlock/test_5.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
    
        std::string expectedOutputFileName = "expected_outputs/CP_TestsWithoutErrorBlocks/CP_BaseBlock/output_5.txt";
...
TEST(CategoryPartition_BaseBlockCriteria, TestCase6) {   
    register_signal_handler(); 
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/CP_TestsWithoutErrorBlocks/CP_BaseBlock/test_6.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
...
TEST(CategoryPartition_BaseBlockCriteria, TestCase7) { 
    register_signal_handler();   
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/CP_TestsWithoutErrorBlocks/CP_BaseBlock/test_7.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
    
        std::string expectedOutputFileName = "expected_outputs/CP_TestsWithoutErrorBlocks/CP_BaseBlock/output_7.txt";
...
TEST(CategoryPartition_BaseBlockCriteria, TestCase8) {    
    register_signal_handler();
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/CP_TestsWithoutErrorBlocks/CP_BaseBlock/test_8.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
    
        std::string expectedOutputFileName = "expected_outputs/CP_TestsWithoutErrorBlocks/CP_BaseBlock/output_8.txt";
...
TEST(CategoryPartition_BaseBlockCriteria, TestCase10) {   
    register_signal_handler(); 
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/CP_TestsWithoutErrorBlocks/CP_BaseBlock/test_10.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
    
        std::string expectedOutputFileName = "expected_outputs/CP_TestsWithoutErrorBlocks/CP_BaseBlock/output_10.txt";
...
TEST(CategoryPartition_BaseBlockCriteria, TestCase11) { 
    register_signal_handler();   
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/CP_TestsWithoutErrorBlocks/CP_BaseBlock/test_11.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
    
        std::string expectedOutputFileName = "expected_outputs/CP_TestsWithoutErrorBlocks/CP_BaseBlock/output_11.txt";
