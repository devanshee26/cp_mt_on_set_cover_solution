...
// Test case 8
TEST(CategoryPartition_BaseBlockCriteria_WithErrorBlocks, TestCase8) {    
    register_signal_handler();
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/CP_TestsWithErrorBlocks/CP_BaseBlock/test_8.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
    
        std::string expectedOutputFileName = "expected_outputs/CP_TestsWithErrorBlocks/CP_BaseBlock/output_8.txt";
...
// Test case 10
TEST(CategoryPartition_BaseBlockCriteria_WithErrorBlocks, TestCase10) {   
    register_signal_handler(); 
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/CP_TestsWithErrorBlocks/CP_BaseBlock/test_10.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
    
        std::string expectedOutputFileName = "expected_outputs/CP_TestsWithErrorBlocks/CP_BaseBlock/output_10.txt";
...
// Test case 11
TEST(CategoryPartition_BaseBlockCriteria_WithErrorBlocks, TestCase11) { 
    register_signal_handler();   
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/CP_TestsWithErrorBlocks/CP_BaseBlock/test_11.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
