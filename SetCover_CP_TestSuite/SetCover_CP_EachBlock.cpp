...
TEST(CategoryPartition_EachBlockCriteria, TestCase1) {
    ...
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/CP_TestsWithoutErrorBlocks/CP_EachBlock/test_1.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
    
        std::string expectedOutputFileName = "expected_outputs/CP_TestsWithoutErrorBlocks/CP_EachBlock/output_1.txt";
...
TEST(CategoryPartition_EachBlockCriteria, TestCase1) {
    ...
    if (setjmp(jump_buffer) == 0) {
        ...
        std::string expectedOutputFileName = "expected_outputs/CP_TestsWithoutErrorBlocks/CP_EachBlock/output_2.txt";
...
TEST(CategoryPartition_EachBlockCriteria, TestCase1) {
    ...
    if (setjmp(jump_buffer) == 0) {
        ...
        std::string expectedOutputFileName = "expected_outputs/CP_TestsWithoutErrorBlocks/CP_EachBlock/output_3.txt";
...
TEST(CategoryPartition_EachBlockCriteria, TestCase1) {
    ...
    if (setjmp(jump_buffer) == 0) {
        ...
        std::string expectedOutputFileName = "expected_outputs/CP_TestsWithoutErrorBlocks/CP_EachBlock/output_4.txt";
...
TEST(CategoryPartition_EachBlockCriteria, TestCase1) {
    ...
    if (setjmp(jump_buffer) == 0) {
        ...
        std::string expectedOutputFileName = "expected_outputs/CP_TestsWithoutErrorBlocks/CP_EachBlock/output_5.txt";
