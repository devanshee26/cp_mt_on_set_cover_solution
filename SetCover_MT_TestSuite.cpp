...
// Test case 1
TEST(Metamorphic_Testing, TestCase1) {
    register_signal_handler();
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/MT/test_1.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
    
        std::string expectedOutputFileName = "expected_outputs/MT/output_1.txt";
...
// Test case 2
TEST(Metamorphic_Testing, TestCase2) {
    register_signal_handler();
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/MT/test_1a.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
...
// Test case 3
TEST(Metamorphic_Testing, TestCase3) {
    register_signal_handler();
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/MT/test_1b.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
...
// Test case 4
TEST(Metamorphic_Testing, TestCase4) {  
    register_signal_handler();  
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/MT/test_2.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
    
        std::string expectedOutputFileName = "expected_outputs/MT/output_2.txt";
...
// Test case 5
TEST(Metamorphic_Testing, TestCase5) {  
    register_signal_handler();  
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/MT/test_2a.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
...
// Test case 6
TEST(Metamorphic_Testing, TestCase6) {   
    register_signal_handler(); 
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/MT/test_2b.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
...
// Test case 7
TEST(Metamorphic_Testing, TestCase7) { 
    register_signal_handler();   
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/MT/test_3.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
    
        std::string expectedOutputFileName = "expected_outputs/MT/output_3.txt";
...
// Test case 8
TEST(Metamorphic_Testing, TestCase8) {    
    register_signal_handler();
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/MT/test_3a.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
...
// Test case 9
TEST(Metamorphic_Testing, TestCase9) { 
    register_signal_handler();   
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/MT/test_3b.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
...
// Test case 10
TEST(Metamorphic_Testing, TestCase10) {   
    register_signal_handler(); 
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/MT/test_4.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
    
        std::string expectedOutputFileName = "expected_outputs/MT/output_4.txt";
...
// Test case 11
TEST(Metamorphic_Testing, TestCase11) { 
    register_signal_handler();   
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/MT/test_4a.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
...
// Test case 12
TEST(Metamorphic_Testing, TestCase12) {  
    register_signal_handler();  
    if (setjmp(jump_buffer) == 0) {
        const char *testArgs[] = { "SetCover.c", "-f", "tests/MT/test_4b.txt" };
        int argc = sizeof(testArgs) / sizeof(testArgs[0]);
